	...
	<div id="wrapper" class="innerPage">
        ...
        <section id="banner" class="banner-slider">
			<div class="banner-img-slider">
				<div>
					<div class="banner-thumb"><img src="assets/images/banner-img/service-banner.png" alt="" class="hide" /></div>
				</div>
			</div>
                    ...
                    <div class="banner-text">
                        <div class="row">
                        	<div class="col-md-6 col-md-offset-3">
                            	<h1>Order for a service here</h1> 
                            </div>
                        </div>
                    </div>
                </div>
          ...
          <!--
            <section id="plumbing-services" class="section-block">
            	<div class="container">
                    ...
                    <div class="row">
                    	<div class="col-sm-4">
                        	<div class="title">Installation, Repair or Replacement:</div>
                            <ul>
                            	<li>Kitchen Sinks / Bathroom Sinks</li>
                                <li>Toilets</li>
                                <li>Power Flush Toilets</li>
                                <li>Tubs / Showers</li>
                                <li>Water Heaters</li>
                                <li>Faucets</li>
                                <li>Gas Lines</li>
                                <li>Washer (laundry)</li>
                                <li>Dishwasher</li>
                                <li>Garbage Disposal</li>
                                <li>Drain Pipes</li>
                                <li>Water Line/Pipes</li>
                                <li>Sump Pump</li>
                                <li>Others</li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
                        	<div class="title">Drain Cleaning and Sewers:</div>
                            <ul>
                                ...
                                <li>Pipe Repair</li>
                                <li>Floor Drains</li>
                                <li>Clear Lines (snaking)</li>
                                <li>Grease Traps</li>
                                <li>Drain and Sew</li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
                        	<div class="title">Maintenance, Repair and Care</div>
                            <ul>
